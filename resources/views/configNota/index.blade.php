								...
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-lg-2 col-md-4 col-sm-10">
											<label class="col-form-label">Nº Série NF-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-2 col-md-4 col-sm-10">
											<label class="col-form-label">Nº Série NFC-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-2 col-md-4 col-sm-10">
											<label class="col-form-label">Nº Série CT-e</label>
											<div class="">
										...
										<div class="form-group validated col-lg-2 col-md-4 col-sm-10">
											<label class="col-form-label">Nº Série MDF-e</label>
											<div class="">
									...
									<div class="row">
										...
										<div class="form-group validated col-lg-2 col-md-4 col-sm-10">
											...
											<div class="">
												<input id="senha_remover" type="text" class="form-control @if($errors->has('percentual_lucro_padrao')) is-invalid @endif" name="percentual_lucro_padrao" value="{{{ isset($config) ? $config->percentual_lucro_padrao : old('percentual_lucro_padrao') }}}">
