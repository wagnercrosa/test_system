...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="d-flex flex-row-fluid flex-column bgi-size-cover bgi-position-center bgi-no-repeat p-10 p-sm-30" >
			<!--begin::Content-->
			<h1 class="font-weight-boldest text-dark-75 mt-15" style="font-size: 10rem">:|</h1>
			<p class="font-size-h3 text-muted font-weight-normal">OOPS! API habilitada na configuração do ecommerce, não é possível iniciar a loja!</p>
			<!--end::Content-->
		</div>
		<!--end::Error-->
	</div>
