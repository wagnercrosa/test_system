...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/mdfe/filtro">
			...
			<br>
			<h4 class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft">Lista de MDFe</h4>

			<label class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft">Registros: <strong class="text-success">{{sizeof($mdfes)}}</strong></label>
			<div class="row @if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft">
												...
												<div class="card card-custom gutter-b example example-compact">
													...
													<div class="card-body">
														...
														<div class="row">
															...
															<!-- <div class="col-sm-6 col-lg-6 col-md-6 col-xl-6">
																<a style="width: 100%; margin-top: 5px;" target="_blank" href="/mdfeSefaz/imprimirCancela/{{$m->id}}" class="btn btn-danger">
																	<i class="la la-print"></i>
