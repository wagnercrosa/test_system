			...
			<div class="col-lg-12" id="content">
				...
				<div class="row">
						...
						<div class="">
							<div class="input-group date">
								<select class="custom-select form-control" id="tpDoc" name="tpDoc">
									<option @isset($mdfe) @if(strlen($mdfe->cnpj_contratante) == 18) selected @endif @endisset value="CNPJ">CNPJ</option>
									<option @isset($mdfe) @if(strlen($mdfe->cnpj_contratante) == 14) selected @endif @endisset value="CPF">CPF</option>
					...
					<div class="form-group col-sm-5 col-lg-4 col-12">
						<label class="col-form-label tpdoclabel">CNPJ do contratante</label>
						<div class="">
							<div class="input-group">
				...
				<div class="row">
					...
					<div class="col-12">
						<div class="row">
							...
							<!-- fim veiculo tração -->
							<div class="form-group col-lg-4 col-md-4 col-sm-6 col-6">
								<label class="col-form-label">Veiculo de reboque 1 (opcional)</label>
								<div class="">
									<div class="input-group date">
							...
							<div class="form-group col-lg-4 col-md-4 col-sm-6 col-6">
								<label class="col-form-label">Veiculo de reboque 2 (opcional)</label>
								<div class="">
									<div class="input-group date">
										<select class="custom-select form-control" id="veiculo_reboque2" name="veiculo_reboque2">
											<option value="">--</option>
											@foreach($veiculos as $v)
											<option value="{{$v}}" @isset($mdfe) @if($v->id == $mdfe->veiculo_reboque2_id) selected @endif @endisset>{{$v->marca}} {{$v->modelo}} - {{$v->placa}}</option>
											@endforeach
										</select>
									</div>
								</div>
								<div id="display-reboque2" class="row" style="display: none"><br>
									<div class="card card-custom gutter-b">
										<div class="card-body">

											<h4 class="center-align">Veiculo de Reboque 2 Selecionado</h4>

											<div class="card-content">
												<p>Marca: <strong id="reboque_marca2"></strong></p>
												<p>Modelo: <strong id="reboque_modelo2"></strong></p>
												<p>Placa: <strong id="reboque_placa2"></strong></p>
												<p>Proprietário: <strong id="reboque_proprietario_nome2"></strong></p>
												<p>Documento Proprietário: <strong id="reboque_proprietario_documento2"></strong></p>
											</div>
										</div>
									</div>
								</div>
							...
							<!-- fim veiculo reboque2 -->

							<div class="form-group col-lg-4 col-md-4 col-sm-6 col-6">
								<label class="col-form-label">Veiculo de reboque 3 (opcional)</label>
								<div class="">
									<div class="input-group date">
										<select class="custom-select form-control" id="veiculo_reboque3" name="veiculo_reboque3">
											<option value="">--</option>
											@foreach($veiculos as $v)
											<option value="{{$v}}" @isset($mdfe) @if($v->id == $mdfe->veiculo_reboque3_id) selected @endif @endisset>{{$v->marca}} {{$v->modelo}} - {{$v->placa}}</option>
											@endforeach
										</select>
									</div>
								</div>
								<div id="display-reboque3" class="row" style="display: none"><br>
									<div class="card card-custom gutter-b">
										<div class="card-body">

											<h4 class="center-align">Veiculo de Reboque 3 Selecionado</h4>

											<div class="card-content">
												<p>Marca: <strong id="reboque_marca3"></strong></p>
												<p>Modelo: <strong id="reboque_modelo3"></strong></p>
												<p>Placa: <strong id="reboque_placa3"></strong></p>
												<p>Proprietário: <strong id="reboque_proprietario_nome3"></strong></p>
												<p>Documento Proprietário: <strong id="reboque_proprietario_documento3"></strong></p>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="row">
					<div class="form-group col-sm-12 col-lg-12 col-12">
						...
						<div class="card card-custom gutter-b">
							<div class="card-body">
								<h3 class="card-title">Produto Predominante</h3>
								<div class="row">

									<div class="form-group col-sm-3 col-lg-6 col-12">
										<label class="col-form-label">Nome</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="produto_pred_nome" class="form-control type-ref" value="{{{ isset($mdfe) ? $mdfe->produto_pred_nome : '' }}}" id="produto_pred_nome"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-2 col-6">
										<label class="col-form-label">NCM</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="produto_pred_ncm" class="form-control ncm" value="{{{ isset($mdfe) ? $mdfe->produto_pred_ncm : '' }}}" id="produto_pred_ncm"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">Código de Barras</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="produto_pred_cod_barras" class="form-control" value="{{{ isset($mdfe) ? $mdfe->produto_pred_cod_barras : '' }}}" id="produto_pred_cod_barras"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">CEP Carrega</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="cep_carrega" class="form-control cep" value="{{{ isset($mdfe) ? $mdfe->cep_carrega : '' }}}" id="cep_carrega"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">Latitude Carrega</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="latitude_carrega" class="form-control lat_lng" value="{{{ isset($mdfe) ? $mdfe->latitude_carregamento : '' }}}" id="latitude_carrega"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">Longitude Carrega</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="longitude_carrega" class="form-control lat_lng" value="{{{ isset($mdfe) ? $mdfe->longitude_carregamento : '' }}}" id="longitude_carrega"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">CEP Descarrega</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="cep_descarrega" class="form-control cep" value="{{{ isset($mdfe) ? $mdfe->cep_descarrega : '' }}}" id="cep_descarrega"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">Latitude Descarrega</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="latitude_descarrega" class="form-control lat_lng" value="{{{ isset($mdfe) ? $mdfe->latitude_descarregamento : '' }}}" id="latitude_descarrega"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">Longitude Descarrega</label>
										<div class="">
											<div class="input-group">
												<input type="text" name="longitude_descarrega" class="form-control lat_lng" value="{{{ isset($mdfe) ? $mdfe->longitude_descarregamento : '' }}}" id="longitude_descarrega"/>
											</div>
										</div>
									</div>

									<div class="form-group col-sm-3 col-lg-3 col-6">
										<label class="col-form-label">Tipo da carga</label>
										<div class="">
											<div class="input-group">
												<select class="form-control custom-select" name="tp_carga" id="tp_carga">
													@foreach(App\Models\Mdfe::tiposCarga() as $key => $t)
																		...
																		<div class="col-xl-12">
																			<div class="row align-items-center">
																				...
																				<div class="form-group col-lg-4 col-md-4 col-sm-4 col-12">
																					...
																					<div class="">
																						<div class="input-group">
																							<input type="text" name="seguradora_numero_apolice" class="form-control" value="{{{ isset($mdfe) ? $mdfe->numero_apolice : '' }}}" id="seguradora_numero_apolice"/>
																						</div>
																					</div>
																				</div>
																				...
																				<div class="form-group col-lg-4 col-md-4 col-sm-4 col-12">
																					...
																					<div class="">
																						<div class="input-group">
																							<input type="text" name="seguradora_numero_averbacao" class="form-control" value="{{{ isset($mdfe) ? $mdfe->numero_averbacao : '' }}}" id="seguradora_numero_averbacao"/>
																						</div>
																					</div>
																				</div>
																			</div>
																			...
																			<div class="col-xl-12">
																				<div class="row align-items-center">
																					...
																					<div class="form-group col-lg-3 col-md-3 col-xl-3 col-12">
																						...
																						<div class="">
																							<div class="input-group">
																								<input type="text" name="condutor_cpf" class="form-control cpf" id="condutor_cpf"/>
																							</div>
																						</div>
																					</div>
															...
															<div class="card-body">
																...
																<div class="row">
																	...
																	<div class="form-group col-lg-6 col-md-6 col-xl-4 col-12">
																		...
																		<div class="">
																			<div class="input-group">
																				<input type="text" data-mask="AAA-0A00" name="id_unid_transp" class="form-control" id="id_unid_transp"/>
																			</div>
																		</div>
																	</div>
...
<script type="text/javascript">
	...
	function docSelect(){
		...
		if(tpDoc == 'CNPJ'){
			...
			$('.tpdoclabel').html('CNPJ do contratante')
		}else{
			$('#cnpj_contratante').mask('000.000.000-00', {reverse: true});
			$('.tpdoclabel').html('CPF do contratante')
		}
	}
