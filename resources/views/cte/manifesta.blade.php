...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/cte/manifestaFiltro">
			...
			<br>
			<h4 class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">Manifesto</h4>

			<a href="/cte/consultaDocumentos" class="btn btn-success @if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">
				<i class="la la-refresh"></i>
				Nova Consulta de Documentos
			</a>

			<h5 class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">Total de registros: <strong style="color: green">{{sizeof($docs)}}</strong></h5>
															...
															<tr class="datatable-row" style="left: 0px;">
																...
																<td class="datatable-cell">
																	<span class="codigo" style="width: 120px;">
																		...
																		<a style="width: 100%;" target="_blank" href="/cte/manifestaImprimir/{{$d->chave}}" class="btn btn-primary">Imprimir CTe</a>
...
<div class="modal fade" id="modal1" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<form method="get" action="/cte/manifestar">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Manifestação de CTe</h5>
				...
				<div class="modal-body">
					...
					<div class="form-group validated col-sm-6 col-lg-6">
						...
						<select class="custom-select form-control" name="evento" id="tipo_evento">
							<option value="1">Desacordo</option>
						</select>
					</div>

					<div class="form-group validated col-sm-12 col-lg-12" id="div-just">
						<label class="col-form-label">Justificativa</label>
						<div class="">
							<input required="" minlength="15" id="justificativa" type="text" class="form-control" name="justificativa" value="">
						</div>
					</div>
