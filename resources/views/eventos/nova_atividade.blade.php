								...
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-3">
											...
											<div class="">
												<input type="text" class="form-control @if($errors->has('crianca_nome')) is-invalid @endif" name="crianca_nome" value="{{old('crianca_nome')}}">
									...
									<div class="categorias" style="margin-top: 15px;">
										...
										<button type="button" @if($key == 0) class="btn btn-info" @else class="btn btn-light" @endif id="cat_{{$c->id}}" onclick="filtraServicos('{{$c->id}}')">
											{{$c->nome}}
										</button>
										@endforeach
									</div>
