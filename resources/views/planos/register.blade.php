							...
							<div class="kt-section kt-section--first">
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-2 col-lg-2">
											<label class="col-form-label">Envio Api Sieg</label>
											<div class="switch switch-outline switch-primary">
												<label class="">
													<input @if(isset($plano) && $plano->api_sieg) checked @endisset value="true" name="api_sieg" class="red-text" type="checkbox">
													<span class="lever"></span>
												</label>
											</div>
										</div>
