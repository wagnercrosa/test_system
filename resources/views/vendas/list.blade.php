...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/vendas/filtro">
					...
					<div class="form-group col-lg-2 col-sm-6">
						...
						<div class="">
							<select name="tipo_pesquisa_data" class="custom-select">
								<option @isset($tipoPesquisaData) @if($tipoPesquisaData == 'data_registro') selected @endif @endif value="data_registro">Data de registro</option>
			...
			<br>
			<h4 class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">Lista de Vendas</h4>

			<label class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">Registros: <strong class="text-success">{{sizeof($vendas)}}</strong></label>
												...
												<table class="datatable-table" style="max-width: 100%; overflow: scroll">
													<thead class="datatable-head">
														<tr class="datatable-row" style="left: 0px;">
															...
															<th data-field="CompanyName" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Pedido Ecommerce</span></th>
														...
														<tr class="datatable-row">
															...
															<td class="datatable-cell">
																<span class="codigo" style="width: 100px;">
																	...
																	<a href="/pedidosEcommerce/detalhar/{{$v->pedido_ecommerce_id}}" class="btn btn-info">{{$v->pedido_ecommerce_id}}</a>
																	@else
																	--
																	@endif
																</span>
															...
															<td>
																<div class="row">
																	<span style="width: 320px;">
																		...
																		<a class="btn btn-danger" onclick='swal("Atenção!", "Deseja remover esta venda?", "warning").then((sim) => {if(sim){ removerVenda("{{$v->id}}") }else{return false} })' href="#!">
																			<i class="la la-trash"></i>
																		</a>
																		...
																		@endif
																		<a title="Imprimir pedido de venda" class="btn btn-info" title="Ver XML" href="/vendas/imprimirPedido/{{ $v->id }}">
											...
											<div class="card card-custom gutter-b example example-compact">
														...
														<div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Ações">
															...
															<div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
																...
																<ul class="navi navi-hover">
																	...
																	<li class="navi-item">
																		<a onclick='swal("Atenção!", "Deseja remover esta venda?", "warning").then((sim) => {if(sim){ removerVenda("{{$v->id}}") }else{return false} })' href="#!" class="navi-link">
																			<span class="navi-text">
												...
												<div class="card-body">
													...
													<div class="row">
														...
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a style="width: 100%; margin-top: 5px;" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/vendas/delete/{{ $v->id }}" }else{return false} })' href="#!" class="btn btn-danger spinner-white spinner-right">
																<i class="la la-check"></i>
																Remover 
															</a>
														</div>
														...
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a id="" style="width: 100%; margin-top: 5px;" href="/vendas/imprimirPedido/{{$v->id}}" class="btn btn-info">
																<i class="la la-print"></i>
																Imprimir pedido
															</a>
														</div>
