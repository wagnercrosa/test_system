...
<div class="card card-custom gutter-b">
	...
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/dfe/filtro">
			...
			<a href="/dfe/novaConsulta" class="btn btn-success @if(getenv('ANIMACAO')) animate__animated @endif animate__backInRight">
