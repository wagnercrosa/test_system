	...
	<div class="card card-custom gutter-b example example-compact">
		<div class="container @if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft">
			<div class="col-lg-12">
				...
				<form method="post" action="{{{ isset($categoria) ? '/categoriasServico/update': '/categoriasServico/save' }}}" enctype="multipart/form-data">
					...
					<div class="card-footer">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6 col-md-4">
								<a style="width: 100%" class="btn btn-danger" href="/categoriasServico">
