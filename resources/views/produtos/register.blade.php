										...
										<div class="row">
											...
											<div class="col-xl-12">
												...
												<div class="form-group validated col-12">
													...
													<span class="switch switch-outline switch-info">
														<label>
															<input @isset($produto) @if($produto->perc_glp != '') checked @endif @endisset @if(old('der_petroleo')) checked @endif
													...
													<div class="row">
														...
														<div class="col col-sm-3 col-lg-3">
															...
															<div class="switch switch-outline switch-success">
																<label class="">
																	<input value="true" name="controlar_estoque" class="red-text" @if(old('controlar_estoque')) checked @endif type="checkbox">
														...
														<div class="col col-sm-3 col-lg-3">
															...
															<div class="switch switch-outline switch-info">
																<label class="">
																	<input value="true" name="status" @if(old('status')) checked @endif class="red-text" type="checkbox">
																	<span class="lever"></span>
																</label>
															</div>
														</div>
														...
														<div class="col col-sm-3 col-lg-3">
															...
															<div class="switch switch-outline switch-primary">
																<label class="">
																	<input value="true" name="destaque" @if(old('destaque')) checked @endif class="red-text" type="checkbox">
																	<span class="lever"></span>
																</label>
															</div>
														</div>
