...
<div class="card card-custom gutter-b">
	<div class="card-body">
		...
		<div class="" id="kt_user_profile_aside" style="margin-left: 10px; margin-right: 10px;">
			...
			<form class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft" method="get" action="/devolucao/filtro">
					...
					<div class="form-group col-lg-3 col-md-4 col-sm-6">
						...
						<div class="">
							<div class="input-group">
								<input type="text" name="fornecedor" class="form-control" value="{{{isset($fornecedor) ? $fornecedor : ''}}}" />
							</div>
						</div>
					</div>
			...
			<br>
			<h4 class="@if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft">Lista de Devoluções</h4>

			<a href="/devolucao/nova" class="btn btn-light-danger @if(getenv('ANIMACAO')) animate__animated @endif animate__backInLeft">
									...
									<div class="row">
												...
												<table class="datatable-table" style="max-width: 100%; overflow: scroll">
													...
													<tbody id="body" class="datatable-body">
														...
														<tr class="datatable-row">
															...
															<td class="datatable-cell"><span class="codigo" style="visibility: hidden" id="id">{{$d->id}}</span>
															</td>
															...
															<td class="datatable-cell"><span class="codigo" style="width: 100px;" id="">{{$d->tipo == 0 ? "Entrada" : "Saída"}}</span>
															</td>
															...
															<td>
																<div class="row">
																	<span style="width: 280px;">
																		...
																		<a class="btn btn-warning" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/devolucao/edit/{{$d->id}}" }else{return false} })' 
																			href="#!">
										...
										<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
											<div class="row" style="margin-top: 5px;">
												...
												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
													<a id="btn-xml" onclick="xmlTemp()" style="width: 100%" class="btn btn-info" href="#modal1">XML temporário</a>
												</div>

												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
													<a id="btn-xml" onclick="danfeTemp()" style="width: 100%" class="btn btn-primary" href="#modal1">DANFE temporária</a>
												</div>

												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
													<a id="btn-correcao" onclick="setarNumero()" data-toggle="modal" data-target="#modal4" style="width: 100%" class="btn btn-warning" href="#modal1">CC-e</a>
												</div>
											</div>
											...
											<div class="row" style="margin-top: 5px;">
												...
												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
													<a id="btn-imprimir-cancela" onclick="imprimirCancela()" style="width: 100%" class="btn btn-danger" href="#!">Imprimir Cancela</a>
												</div>
												<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
											...
											<div class="card card-custom gutter-b example example-compact">
												...
												<div class="card-body">
													...
													<div class="row">
														...
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a target="_blank" style="width: 100%; margin-top: 5px;" href="/devolucao/imprimir/{{$d->id}}" class="btn btn-primary">
														...
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a id="btn_cancela_correcao_{{$d->id}}" style="width: 100%; margin-top: 5px;" href="#!" onclick="corrigirNFe('{{$d->id}}', '{{$d->numero_gerado}}')" class="btn btn-warning spinner-white spinner-right">
																<i class="la la-check"></i>
																Corrigir NFe
															</a>
														</div>
														...
														@if($d->estado == 3)
														<div class="col-sm-12 col-lg-12 col-md-12 col-xl-6">
															<a target="_blank" style="width: 100%; margin-top: 5px;" href="/devolucao/imprimirCancela/{{$d->id}}" class="btn btn-danger">
																<i class="la la-print"></i>
																Imprimir
															</a>
														</div>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CANCELAR NFe DEVOLUÇÃO <strong class="text-danger" id="numero_cancelamento"></strong></h5>
...
<div class="modal fade" id="modal1_aux" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CANCELAR NFe DEVOLUÇÃO <strong class="text-danger" id="numero_cancelamento2"></strong></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
...
<div class="modal fade" id="modal4" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">CARTA DE CORREÇÃO NFe DEVOLUÇÃO <strong class="text-danger" id="numero_correcao"></strong></h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					x
				</button>
			</div>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Fechar</button>
				<button type="button" id="btn-corrigir-2" onclick="cartaCorrecao()" class="btn btn-light-success font-weight-bold spinner-white spinner-right">Corrigir NFe Devolução</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="modal4_aux" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-light-danger font-weight-bold" data-dismiss="modal">Fechar</button>
				<button type="button" id="btn-corrigir-2-aux" onclick="cartaCorrecaoAux()" class="btn btn-light-success font-weight-bold spinner-white spinner-right">Corrigir NFe Devolução</button>
			</div>
		</div>
	</div>
</div>
