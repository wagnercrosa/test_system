...
class PedidoEcommerceController extends Controller
{
    ...
    public function filtro(Request $request){
        ...
        if($request->transacao_id){
            $pedidos->where('pedido_ecommerces.transacao_id', "$request->transacao_id");
        }
        ...
        ->with('transacao_id', $request->transacao_id)
    ...
    public function alterarStatusPagamento(Request $request){
        try{
            ...
            $pedido->save();
            session()->flash("mensagem_sucesso", "Status de pagamento alterado!");
