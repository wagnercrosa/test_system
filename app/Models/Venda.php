...
class Venda extends Model
{
    protected $fillable = [
        ...
        'descricao_pag_outros', 'acrescimo', 'data_entrega'
    ];
    ...
    public static function filtroData($dataInicial, $dataFinal, $estado, $tipoPesquisaData){
        $value = session('user_logged');
        $empresa_id = $value['empresa'];
        $c = Venda::
        select('vendas.*')
